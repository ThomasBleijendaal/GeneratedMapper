...
[assembly: MapperGeneratorConfiguration(GenerateEnumerableMethods = false, NamespacesToInclude = new[] { ""Hard.To.Recognize.Namespace"" }, GenerateDocComments = false)]
namespace A {
    [MapTo(typeof(B.B))]
...
[assembly: MapperGeneratorConfiguration(GenerateEnumerableMethods = false, ThrowWhenNotNullablePropertyIsNull = false, GenerateDocComments = false)]
namespace A {
    [MapTo(typeof(B.B))]
    public class A { public string Name { get; set; } }
}
...
[assembly: MapperGeneratorConfiguration(GenerateEnumerableMethods = false, ThrowWhenNotNullableElementIsNull = false, GenerateDocComments = false)]
namespace A {
    [MapTo(typeof(B.B))]
...
[assembly: MapperGeneratorConfiguration(GenerateEnumerableMethods = false, GenerateEnumerableMethods = true, GenerateDocComments = false)]
namespace A {
    [MapTo(typeof(B.B))]
    public class A { public string Name { get; set; } }
}
