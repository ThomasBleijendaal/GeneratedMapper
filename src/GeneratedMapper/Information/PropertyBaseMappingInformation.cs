...
namespace GeneratedMapper.Information
{
    internal abstract class PropertyBaseMappingInformation
    {
        ...
        public ParameterInformation? SourcePropertyExtensionMethodTypeParameter { get; private set; }

        public List<PropertyElementMappingInformation> CollectionElements { get; private set; } = new();

        public void UsingMethod(string methodType, string method, string? methodNamespace, IEnumerable<ParameterInformation> methodParameters, ParameterInformation? typeParameter = null)
        {
            ...
            {
                SourcePropertyExtensionMethodTypeParameter = typeParameter;
